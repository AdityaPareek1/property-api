...
<?php if($SearchData=="404"){?>
  <!--Rent_1_start-->
<div class="proparty_details pro_list">
  <div class="container">
 
  <h3>Search Result Not Found </h3>
  <h3>Sumiler result found to help  for finding </h3>
...
<div class="proparty_details pro_list">
  ...
  <?php   foreach($SearchData as $data)  {?>
   ...
   <?php } ?>
   <?php }else{ ?>
    <h1>Search Data Not Found Search Again  </h1>
       <?=$this->element('Search');?> 
        <h3>See All Property  <a class="pase_rs"  href="http://localhost/property/search/search"> Click Hare </a> </h3>
       <?php } ?>
    </div>
</div>
    <?php } ?>
