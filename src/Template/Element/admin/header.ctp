<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="sitecss/assets/img/favicon.png" type="image/x-icon">
    ...
    <!-- Morris Chart Css-->
    <link href="<?php echo ADMIN_URL; ?>plugins/morrisjs/morris.css" rel="stylesheet" />

    <!-- Custom Css -->
    <link href="<?php echo ADMIN_URL; ?>css/style.css" rel="stylesheet">

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link href="<?php echo ADMIN_URL; ?>css/themes/all-themes.css" rel="stylesheet" />
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
  <link href="https://cdn.datatables.net/1.10.20/css/jquery.dataTables.min.css" rel="stylesheet">
  <script src="<?php echo SITE_URL; ?>js/daterangepicker.js"></script>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">ADMIN - Property</a>
            </div>
