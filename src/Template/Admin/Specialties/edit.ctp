        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <!-- <form role="form"> -->
              <?php echo $this->Form->create($Specialtie)?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <?php if($Specialtie['dishimg']){?>
                    <img src="<?php echo SITE_URL ?>/dishimg/<?php echo $Specialtie['dishimg'];?>" height="50px" width="50px">
                    <a href="<?php echo ADMIN_URL ?>Specialtie/remove/<?php echo $Specialtie['id']; ?>">remove</a>
